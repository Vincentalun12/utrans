...
export function OrganismSidebar() {
    ...
    return (
        <Card className="h-screen fixed top-0 w-full max-w-full lg:max-w-[18rem] shadow-md shadow-blue-gray-900/5 rounded-none p-4 z-10 lg:flex hidden overflow-y-auto">
