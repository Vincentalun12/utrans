...
import { Language } from "@/Languages/Organism/Navbar";
...
export function OrganismNavbar({ user }) {
    ...
    return (
        <nav className="w-full h-[66px] lg:h-[76px] max-w-auto bg-white sticky sm:fixed top-0 z-20">
            <div className="mx-auto px-6 sm:px-6 lg:px-8">
                <div className="flex h-20 justify-between shrink-0 items-center">
                    ...
                    <MoleculesDropdown>
                        <Tooltip
                            placement="left"
                            content={Language.tooltip + user.name}
                        >
                            <Menu
