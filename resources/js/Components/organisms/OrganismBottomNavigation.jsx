...
export function OrganismBottomNavigation() {
    ...
    return (
        <div className="fixed bottom-0 w-full lg:hidden inline-flex justify-between bg-white">
            {isNavVisible && (
                <div className="grid grid-cols-5 items-center flex-grow pl-4">
                    <Linkactive href={route("dashboard")}>
                        <Button variant="text" className="inline-flex flex-col items-center justify-center font-medium py-3 px-4 text-ungukita rounded-none">
                            <HomeIcon className="w-7 h-7" />
                            <span>Home</span>
                        </Button>
                    </Linkactive>
                    <Linkactive href={route("inventorymenu")}>
                        <Button variant="text" size="xs" className="inline-flex flex-col items-center justify-center font-medium py-3 px-4 text-ungukita rounded-none">
                    ...
                    <Linkactive href={route("sales")}>
                        <Button variant="text" size="xs" className="inline-flex flex-col items-center font-medium text-ungukita py-3 px-4 rounded-none">
