export default function ButtonLogin({ className = '', disabled, children, ...props }) {
    return (
        <button
            {...props}
            className={
                `class="block w-full select-none rounded-lg bg-ungukita py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-purple-900/20 transition-all hover:shadow-lg hover:shadow-purple-900/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                type="button"
