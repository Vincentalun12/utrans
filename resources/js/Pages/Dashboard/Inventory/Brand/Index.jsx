...
export default function Brand({ auth, brands, deleteSuccess }) {
  ...
  const handleNext = () => {
    if (paginated.length === itemsPerPage && currentPage < Math.ceil(brands.length / itemsPerPage)) {
      setCurrentPage(currentPage + 1);
    }
  };
                    ...
                    return (
                      <tr key={code} className="even:bg-gray-100">
                        ...
                        <td className="p-4 flex gap-2">
                          ...
                          <Typography
                            as="a"
                            onClick={() => destroy(route('brands.destroy', id), {
                              onSuccess: () => {
                                setIsShowAlert(true)
                              }
                            })}
            ...
            <div className="flex justify-between">
              <div className="pt-2">
                <Typography variant="small" color="blue-gray" className="font-normal">
                  Page {currentPage} of {Math.ceil(brands.length / itemsPerPage)}
                </Typography>
              </div>
