  ...
  const addToPurchaseList = (item) => {
    setPurchaseList((prevList) => {
      ...
      if (existingItemIndex !== -1) {
        ...
        updatedList[existingItemIndex].qty += 1;
        return updatedList;
      }
      return [...prevList, { ...item, qty: 1 }];
    });
  };
      ...
      <div className="px-3 gap-2 py-2 shadow-sm bg-white sticky top-0 z-50">
        <div className="flex justify-start">
          <img
            src={utranslogoaja}
            alt="Logo"
            className="h-8 w-auto mr-2 pl-2.5 mt-1"
          />
          ...
          <QrCodeIcon
            className="h-10 w-10 cursor-pointer text-ungukita"
            onClick={() => {
      ...
      <div className="flex flex-col lg:flex-row bg-gray-200 h-full">
        <div className="w-24 bg-white p-3 lg:flex hidden">
          <div className="flex-grow flex flex-col items-center justify-start">
            <IconButton
              size="lg"
              className="bg-ungukita mb-4 rounded-full"
        ...
        <div className="w-full overflow-auto lg:h-auto min-h-[800px]">
          <div className="flex justify-end px-4 py-2">
            <IconButton
              className="rounded-full bg-ungukita"
          ...
          <div className="grid px-4 py-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-5 gap-4">
            {currentItems.map((item) => (
              <div
                ...
                onClick={() => addToPurchaseList({ name: item.name, price: item.sales_price })}
              >
                <a href="#">
                ...
                <div className="px-5 pb-5">
                  <a href="#">
                    <h3 className="text-gray-900 font-light text-[18px] tracking-tighter dark:text-white">
                      {item.name}
                    </h3>
                  </a>
        ...
        <Dialog open={open} handler={handleOpen}>
          <div className="flex items-center mt-4 ml-4 font-sans text-2xl antialiased font-semibold leading-snug shrink-0 text-blue-gray-900">
            Order Confirmation
          </div>
          <div className="flex items-center ml-4 mb-4 font-sans text-sm antialiased font-italic leading-snug shrink-0 text-blue-gray-900">
            Please confirm your order before checkout
          </div>
          <div className="flex items-center ml-4 font-sans text-sm antialiased font-italic leading-snug shrink-0 text-blue-gray-900">
          ...
          <div className="flex items-center ml-4 mb-4 font-sans text-sm antialiased font-italic leading-snug shrink-0 text-blue-gray-900">
            ...
            >
              ...
              Make sure your order is correct. Any changes after checkout are
              not allowed.
            </Typography>
          </div>
          <DialogBody>
            <div className="relative font-sans text-base antialiased font-semilight leading-relaxed border-t border-b border-t-blue-gray-100 border-b-blue-gray-100 text-blue-gray-500">
              <div className="grid lg:grid-cols-3 grid-cols-1 divide-x-2">
                <div
                  className="col-span-2 items-center justify-center overflow-auto"
                ...
                <div className="ml-4">
                  <div className="py-4 rounded-md">
                    <div className="ml-3 px-4 flex justify-between ">
                      <span className="font-semibold text-md">Subtotal</span>
                      <span className="font-bold">Rp{getTotalAmount()}</span>
                    </div>
                    <div className="ml-3 px-4 flex justify-between ">
                      <span className="font-semibold text-md">Diskon</span>
                      <div className="text-md">
                        Rp
                        <input
                          type="text"
                          className="text-right h-4 w-24 bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none"
                          wfd-id="id1"
                        />
                      </div>
                    </div>
                    <div className="ml-3 px-4 flex justify-between ">
                      <span className="font-semibold text-md">PPN</span>
                      <span className="font-bold">11%</span>
                    </div>
                    <div className="border-t-2 ml-3 mt-3 py-2 px-4 flex items-center justify-between">
                      <span className="text-xl">Total</span>
                      <span className="font-bold text-xl">Rp{getTotalAmount()}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full lg:w-[700px] bg-white p-3">
          <div className="flex flex-row items-center justify-stretch px-5 mt-5">
          ...
          <div className="px-2 py-4 mt-5 overflow-y-auto h-72 pl-4">
            {purchaseList.map((item, index) => (
              <div
                className="flex flex-row justify-stretch items-center mb-4"
                key={index}
              >
                ...
                <div className="w-32 flex justify-stretch">
                  <span
                  ...
                  <span className="font-semibold mx-4">{item.qty}</span>
                  <span
                    className="px-3 py-1 rounded-md bg-gray-300 cursor-pointer"
                    onClick={() => handleQuantityChange(index, 1)}
                  >
                ...
                <div className="font-semibold text-md w-16">
                  Rp {item.price}
                </div>
              </div>
            ))}
          ...
          <div className="px-5 mt-5">
            <div className="py-4 rounded-md shadow-lg">
              ...
              <div className="px-4 flex justify-between ">
                <span className="font-semibold text-sm">PPN</span>
                <span className="font-bold">11%</span>
              </div>
              <div className="border-t-2 mt-3 py-2 px-4 flex items-center justify-between">
                <span className="font-semibold text-2xl">Total</span>
                <span className="font-bold text-2xl">Rp{getTotalAmount()}</span>
              </div>
            </div>
          </div>
          <div className="px-5 mt-5">
            <button
              onClick={handleOpen}
              className="px-4 py-4 rounded-md shadow-lg text-center bg-ungukita text-white font-semibold w-full"
            >
              Checkout
            </button>
          </div>
