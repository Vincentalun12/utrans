...
export default function Dashboard({ auth }) {
    ...
    return (
        ...
        <img src={noimage} alt="Utrans logo" className="block ml-auto mr-auto"/>
			...
			<div class="px-5 pb-5">
				<a href="#">
					<h3 class="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Keran 2G22</h3>
				</a>
				<div class="flex items-center justify-between">
					<span class="text-md font-bold text-gray-900 dark:text-white">Rp100.000</span>
