...
export default function Dashboard({ auth }) {
  return (
    <div class="flex-grow flex">
          ...
          <div class="h-full overflow-y-auto px-2">
            ...
            >
              <div class="w-full text-center">
                ...
                <p class="text-xl">
                  EMPTY SEARCH RESULT
                  <br />"<span x-text="keyword" class="font-semibold"></span>"
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div x-for="product in filteredProducts()">
                <div
                  role="button"
      ...
      <div class="select-none h-auto w-3/12 text-center pt-3 pb-4 px-4">
        ...
        <div class="flex mb-3 text-lg font-semibold text-blue-gray-700">
          <div>TOTAL</div>
          <div class="text-right w-full" x-text="priceFormat(getTotalPrice())">
            Rp1.300.000
          </div>
        </div>
          ...
          <div class="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
            ...
            <div class="grid grid-cols-3 gap-2 mt-2">
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">2.000</span>
              </button>
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">5.000</span>
              </button>
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">10.000</span>
              </button>
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">20.000</span>
              </button>
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">50.000</span>
              </button>
              ...
              <button
                ...
                class="bg-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm"
              >
                +<span x-text="numberFormat(money)">100.000</span>
              </button>
            </div>
          </div>
          <hr class="my-2" />
        ...
        <button
          class="text-white rounded-2xl text-lg w-full py-3 focus:outline-none bg-cyan-500 hover:bg-cyan-600"
          x-bind:class="{
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="flex-grow">No: <span x-text="receiptNo">TWPOS-KS-1714050380</span></div>
            <div x-text="receiptDate">25/04/24, 20.06</div>
          </div>
            <hr class="my-2" />
            <div>
            ...
            <div>
              <div class="flex font-semibold">
                ...
                <div x-text="priceFormat(getTotalPrice())">Rp 40.000</div>
              </div>
              <div class="flex text-xs font-semibold">
                <div class="flex-grow">PAY AMOUNT</div>
                <div x-text="priceFormat(cash)">Rp 35.000</div>
              </div>
              <hr class="my-2" />
              <div class="flex text-xs font-semibold">
                <div class="flex-grow">CHANGE</div>
                <div x-text="priceFormat(change)">Rp 5.000</div>
              </div>
            </div>
          </div>
