...
let Language = new LocalizedStrings({
    id: {
        "title": "Edit Bagan Akun (COA)",
        "description": "Edit data bagan akun anda. Mohon jangan mengubah data jika tidak perlu.",
        "journaltype": {
            "name": "Tipe Jurnal",
    ...
    en: {
        ...
        "description": "Edit your chart of account data. Please do not change the data if it is not necessary.",
        "journaltype": {
            "name": "Journal Type",
