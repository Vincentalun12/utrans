...
let Language = new LocalizedStrings({
    id: {
        ...
        "description": "Edit data pelanggan setia anda. Mohon jangan mengubah data jika tidak perlu.",
        "customer": {
    ...
    en: {
        ...
        "description": "Edit your loyal customers data. Please do not change the data if it is not necessary.",
        "customer": {
