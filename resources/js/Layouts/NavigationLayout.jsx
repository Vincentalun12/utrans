...
<div className="min-h-screen bg-gray-100">
   <nav className="bg-ungukita border-b border-gray-100 static top-0 w-full z-50">
   ...
   <div className="flex">
      <card className="static flex z-20 h-full pt-16 lg:flex flex-col w-64 bg-white">
